            ...
            if (allInputsDone) {
                try {
                    ...
                    await db.execute(`
                        ...
                        (sender_id, project_id,input_id, message_text, message_type, timestamp) 
                        VALUES (?, ?, ?,?, ?, NOW())
                    `, [12, projectId,id.id, message, 'text']);                  
                    ...
                    else if(project_info[0]["primary_technique_id"] === "c1b" && project_info[0]["secondary_technique_id"] === "fp")
                    {
                        ...
                        await cocomo1.basic_calculate(project_info[0]["estimation_id"]);
                    }
                    else if(project_info[0]["primary_technique_id"] === "c1b" && project_info[0]["secondary_technique_id"] === "kloc")
                    {
                        cocomo1.basic_calculate(project_info[0]["estimation_id"]);
                    }

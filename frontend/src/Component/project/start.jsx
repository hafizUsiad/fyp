                           ...
                           <tr key={input.input_id}>
                            ...
                            <td>
                                ...
                                >
                                    ...
                                    ):(project.estimation_method === "FC" && project.primary_technique_id === "UC") || (project.estimation_method === "FC" && project.primary_technique_id === "c1b")?(
                                        <> 
                                        {assigned_weights.map((item) => (
                                                <option key={item.weight_id} value={item.weight}>
                                                    {item.weight} 
                                    ...
                                    ):project.estimation_method === "PP" && (project.primary_technique_id === "FP" || project.primary_technique_id === "c1b") ?(
                                      <> 

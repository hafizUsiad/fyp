...
function Project()
{
    ...
    useEffect(() => {
      ...
      const handleSubmit = async (e) => {
        e.preventDefault();
        try {
          const res = await axios.post(`${server}/api/project/createproject`, project);
          alert(res.data.msg);
          navigate("/project");
        } catch (error) {
 ...
 <div className="col-lg-4 col-md-6" key={project.project_id}>
            ...
            <div className="card card-block card-stretch card-height">
              <div className="card-body">
                ...
                <p className="mb-3">{project.project_description}</p>
                ...
                {project.users && project.users.trim() ? (
                        ...
                        <a href={`/project/${project.project_id}/start`} className="iq-media">
                        Assign Team<i class="ri-user-add-line mr-0"></i>
                        </a>
                    )}
                    </div>
